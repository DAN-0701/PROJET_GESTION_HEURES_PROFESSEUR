    ...
    >
      <div class="sidebar-inner">
        ...
        <ul class="nav flex-column sidebar-menu">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/professeur/dashbordprof">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/professeur/consultheure">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/professeur/statprof">
              <i class="bi bi-graph-up"></i>
              <span v-if="!isCollapsed">Statistiques</span>
            </router-link>
          </li>
